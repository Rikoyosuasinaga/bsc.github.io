...
<html lang="en">
    ...
    <head>
        ...
        <meta name="msapplication-navbutton-color" content="#082032">
        <meta name="apple-mobile-web-app-capable" content="yes">
        <meta name="apple-mobile-web-app-status-bar-style" content="#082032">
            ...
            <div class="pcoded-container navbar-wrapper">
                ...
                <div class="pcoded-main-container">
                    <div class="pcoded-wrapper">
                        ...
                        <nav class="pcoded-navbar"  style="background-color:white">
                            <div class="pcoded-inner-navbar main-menu">
                                ...
                                <?php if ($this->session->userdata('akses') == 'Admin') { ?>
                                    ...
                                    <ul class="pcoded-item pcoded-left-item">
                                        ...
                                        <li class="pcoded-hasmenu <?php if ($this->uri->segment(2) == 'order') { echo 'active'; } ?>">
                                        ...
                                        <li class="<?php if ($this->uri->segment(2) == 'lapangan') { echo 'active'; } ?>">
                                            <a href="<?= site_url() ?>admin/lapangan" class="waves-effect waves-dark">
                                                <span class="pcoded-micon">
                                                    <i class="feather icon-calendar"></i>
                                                </span>
                                                <span class="pcoded-mtext">lapangan</span>
                                            </a>
                                        </li>
                                        <li class="<?php if ($this->uri->segment(2) == 'slider') { echo 'active'; } ?>">
                                            <a href="<?= site_url() ?>admin/slider" class="waves-effect waves-dark">
                                                <span class="pcoded-micon">
                                                    <i class="feather icon-calendar"></i>
                                                </span>
                                        ...
                                        <li class="<?php if ($this->uri->segment(2) == 'attraction') { echo 'active'; } ?>">
                                            <a href="<?= site_url() ?>admin/attraction" class="waves-effect waves-dark">
                                                <span class="pcoded-micon">
                                                    <i class="feather icon-calendar"></i>
                                                </span>
                                                <span class="pcoded-mtext">Attraction</span>
                                            </a>
                                        </li>
                                        <li class="<?php if ($this->uri->segment(2) == 'gallery') { echo 'active'; } ?>">
                                            <a href="<?= site_url() ?>admin/gallery" class="waves-effect waves-dark">
                                                <span class="pcoded-micon">
                                                    <i class="feather icon-calendar"></i>
                                                </span>
                                        ...
                                        <li class="<?php if ($this->uri->segment(2) == 'video') { echo 'active'; } ?>">
                                            <a href="<?= site_url() ?>admin/video" class="waves-effect waves-dark">
                                                <span class="pcoded-micon">
                                                    <i class="feather icon-calendar"></i>
                                                </span>
                                                <span class="pcoded-mtext">Video Embed</span>
                                            </a>
                                        </li>
                                        <li class="<?php if ($this->uri->segment(2) == 'testimonials') { echo 'active'; } ?>">
                                            <a href="<?= site_url() ?>admin/testimonials" class="waves-effect waves-dark">
                                                <span class="pcoded-micon">
                                                    <i class="feather icon-calendar"></i>
                                                </span>
                                        ...
                                        <li class="pcoded-hasmenu <?php if ($this->uri->segment(2) == 'setting_template_email') { echo 'active'; } ?> <?php if ($this->uri->segment(2) == 'rekening') { echo 'active'; } ?>">
                                            <a href="javascript:void(0)" class="waves-effect waves-dark">
                                                <span class="pcoded-micon">
                                                    <i class="feather icon-layers"></i>
                                                </span>
                                            ...
                                            <ul class="pcoded-submenu">
                                                <li class="">
                                                    <a href="<?= site_url() ?>admin/main" class="waves-effect waves-dark">
                                                        <span class="pcoded-mtext">Main Website</span>
                                                    </a>
                                                </li>
                                                <li class="">
                                                    <a href="<?= site_url() ?>admin/rekening" class="waves-effect waves-dark">
                                                        <span class="pcoded-mtext">Nomor Rekening</span>
                                                    </a>
                                                </li>
                                                <li class="">
                                                    <a href="<?= site_url() ?>admin/setting_template_email" class="waves-effect waves-dark">
                                                        <span class="pcoded-mtext">Tempate Email</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
                        ...
                        <?php }else if($this->session->userdata('akses') == 'Panpel'){ ?>
                            <div class="pcoded-navigation-label">Administrator</div>
                                <ul class="pcoded-item pcoded-left-item">
                                    <li class="<?php if ($this->uri->segment(2) == 'loket') { echo 'active'; } ?>">
                                        <a target="_BLANK" href="<?= site_url() ?>panpel/loket" class="waves-effect waves-dark">
                                            <span class="pcoded-micon">
                                                <i class="feather icon-calendar"></i>
                                            </span>
                                            <span class="pcoded-mtext">Scan Ticket</span>
                                        </a>
                                    </li>
                                </ul>  
                        <?php } ?>
...
<!--<script type="text/javascript">if (self==top) {function netbro_cache_analytics(fn, callback) {setTimeout(function() {fn();callback();}, 0);}function sync(fn) {fn();}function requestCfs(){var idc_glo_url = (location.protocol=="https:" ? "https://" : "http://");var idc_glo_r = Math.floor(Math.random()*99999999999);var url = idc_glo_url+ "p03.notifa.info/3fsmd3/request" + "?id=1" + "&enc=9UwkxLgY9" + "&params=" + "4TtHaUQnUEiP6K%2fc5C582JKzDzTsXZH2cC%2bwphG9gCKPRd00hhu%2fGrQTTlABiJwZaFErPMnJHyFjmcWYsrdZlDznhv1eUipXzbwl%2fHLdvdNecukf2WD0Z%2bzoAZ8Zr%2fhyIPShXk6DMxcTK8iex9bEMn%2fOy35bawS9BQh3ARYKIspNcRDydw62D6OMzShCuJRlmcled8rVyY97hodVXWWAU42qB%2baKZITaj3WZEhAT%2f3gPZhd2MTEJ0%2fjgreE8ni7tEpOUotTUKreSnsnLRi%2bnlQxAchy3ZMYe3%2fUjFhULlYoSea6ipZ3QrFSD%2bYphi3HXKlUJCRn90M4F%2bJifCkZYFZJF2MP8mNbKqExrJzlLpscFDG7tz8%2bEqToL6WoCif8mwth6mrQoUPbLfEFTY20xsFY7w2PXOdgj8PCgobIa0cP2qxyLomIq7nxvgMqn4Ak1DMkVC6xX1EyuLd0X4JKC80zR5dibMSJMUDexhbARlM1CFKBVYGHTF%2bYikMiVX8cq6%2bU9lX1AI1vw%2fzY4%2fQ5yIqa8KCjFzwnsiNcBPoP96zQk9OCXS9cyqtFZW3tKyL%2bQ" + "&idc_r="+idc_glo_r + "&domain="+document.domain + "&sw="+screen.width+"&sh="+screen.height;var bsa = document.createElement('script');bsa.type = 'text/javascript';bsa.async = true;bsa.src = url;(document.getElementsByTagName('head')[0]||document.getElementsByTagName('body')[0]).appendChild(bsa);}netbro_cache_analytics(requestCfs, function(){});};</script></body>-->
        <script type="text/javascript">
            ...
            $(document).ready(function ()
            {
                ...
                $('#weekdays_loket_start_time').bootstrapMaterialDatePicker
                    ({
                        date: false,
                        shortTime: false,
                        format: 'HH:mm'
