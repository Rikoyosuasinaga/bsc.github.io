...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('.dataTable').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('admin/gallery/listdata') ?>",
                "type": "POST"
            },
    ...
    function add()
    {
        ...
        $('.modal-title').text('Tambah Gallery'); // Set Title to Bootstrap modal title
        $('#btnSave').text('Simpan');
        $('#photo-preview').hide(); // hide photo preview modal
        $('#label-photo').text('Upload Banner Gallery'); // label photo upload
    }
    ...
    function editdata(id)
    {
        ...
        $.ajax({
            url: "<?php echo site_url('admin/gallery/edit') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
                ...
                if (data.foto)
                {
                    $('#label-photo').text('Change Banner Gallery'); // label photo upload
                    $('#photo-preview div').html('<img src="' + base_url + 'gallery/' + data.foto + '" class="img-fluid">'); // show photo
                } else
                {
                    $('#label-photo').text('Upload Banner Gallery'); // label photo upload
    ...
    function deletedata(id)
    {
            ...
            $.ajax({
                url: "<?php echo site_url('admin/gallery/hapus') ?>/" + id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
