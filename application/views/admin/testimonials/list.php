...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('.dataTable').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('admin/testimonials/listdata') ?>",
                "type": "POST"
            },
    ...
    function add()
    {
        ...
        $('.modal-title').text('Tambah Testimonials'); // Set Title to Bootstrap modal title
        $('#btnSave').text('Simpan');
    ...
    function editdata(id)
    {
        ...
        $.ajax({
            url: "<?php echo site_url('admin/testimonials/edit') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
                ...
                $('[name="testi"]').val(data.testi);
                $('#tambah').modal('show'); // show bootstrap modal
                $('.modal-title').text('Edit Testimonials'); // Set Title to Bootstrap modal title
                $('#btnSave').text('Update');
                $('#photo-preview').show(); // hide photo preview modal
                if (data.foto)
                {
                    $('#label-photo').text('Change Foto'); // label photo upload
                    $('#photo-preview div').html('<img src="' + base_url + 'testimonials/' + data.foto + '" class="img-fluid">'); // show photo
                } else
                {
                    $('#label-photo').text('Upload Foto'); // label photo upload
    ...
    function save()
    {
        ...
        if (save_method == 'add') {
            url = "<?php echo site_url('admin/testimonials/save') ?>";
        } else {
            url = "<?php echo site_url('admin/testimonials/update') ?>";
        }
    ...
    function deletedata(id)
    {
            ...
            $.ajax({
                url: "<?php echo site_url('admin/testimonials/hapus') ?>/" + id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
                        ...
                        <div class="col-sm-12">
                            <div class="material-group material-group-danger">
                                ...
                                <div class="form-group form-danger form-static-label">
                                    <input name="nama" class="form-control" type="text" value="" placeholder="Nama">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <div class="material-group material-group-danger">
                                ...
                                <div class="form-group form-danger form-static-label">
                                    <textarea class="form-control" name="Testi" rows="3" placeholder="Testimonials"></textarea>
                                    <span class="form-bar"></span>
                                    <label class="float-label">Testimonials</label>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12">
                            <div class="material-group material-group-danger">
                                ...
                                <div class="form-group form-danger form-static-label">
                                    ...
                                    <input class="form-control" id="namafile" type="text" onclick="document.getElementById('fileup').click()" placeholder="Insert File Banner Slider">
                                    <span class="form-bar"></span>
