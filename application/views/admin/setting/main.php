...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('.dataTable').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('admin/main/listdata') ?>",
                "type": "POST"
            },
    ...
    function editdata(id)
    {
        ...
        $.ajax({
            url: "<?php echo site_url('admin/main/edit') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
                ...
                $('.modal-title').text('Edit Main Website'); // Set Title to Bootstrap modal title
                $('#btnSave').text('Update');
    ...
    function save()
    {
        ...
        if (save_method == 'add') {
            url = "<?php echo site_url('admin/main/save') ?>";
        } else {
            url = "<?php echo site_url('admin/main/update') ?>";
        }
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <div class="material-group material-group-danger">
                                ...
                                <div class="form-group form-danger form-static-label">
                                    <input name="whatsapp" class="form-control" type="text" value="cvcvcv" placeholder="Whatsapp example 085699854458">
                                    <span class="form-bar"></span>
