...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('.dataTable').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('admin/rekening/listdata') ?>",
                "type": "POST"
            },
    ...
    function editdata(id)
    {
        ...
        $.ajax({
            url: "<?php echo site_url('admin/rekening/edit') ?>/" + id,
            type: "GET",
            dataType: "JSON",
    ...
    function save()
    {
        ...
        if (save_method == 'add') {
            url = "<?php echo site_url('admin/rekening/save') ?>";
        } else {
            url = "<?php echo site_url('admin/rekening/update') ?>";
        }
    ...
    function deletedata(id)
    {
            ...
            $.ajax({
                url: "<?php echo site_url('admin/rekening/hapus') ?>/" + id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
                        ...
                        <div class="col-sm-12">
                            <div class="material-group material-group-danger">
                                ...
                                <div class="form-group form-danger form-static-label">
                                    <input name="bank" class="form-control" type="text" value="" placeholder="Nama Bank">
                                    <span class="form-bar"></span>
                                    <label class="float-label">Nama Bank</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <div class="material-group material-group-danger">
                                ...
                                <div class="form-group form-danger form-static-label">
                                    <input name="no" class="form-control" type="number" value="" placeholder="Nomor Rekening">
                                    <span class="form-bar"></span>
                                    <label class="float-label">Nomor Rekening</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <div class="material-group material-group-danger">
                                ...
                                <div class="form-group form-danger form-static-label">
                                    <input name="nama" class="form-control" type="text" value="" placeholder="Nama Rekening">
                                    <span class="form-bar"></span>
                                    <label class="float-label">Nama Rekening</label>
                                </div>
                            </div>
                        </div>
                    </div>
