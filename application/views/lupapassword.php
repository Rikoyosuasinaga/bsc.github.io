...
<head>
  ...
  <!-- Favicons-->
  <link rel="icon" href="<?= base_url() ?>assets/main/images/banner.png" sizes="32x32">
  <!-- Favicons-->
    ...
    <div class="col s12 z-depth-4 card-panel">
        ...
        <div class="row">
          <div class="input-field col s12 center">
            <img src="<?= base_url() ?>assets/admin/images/banner.png" alt="" class="circle responsive-img valign profile-image-login">
            <p class="center login-form-text">Lupa Password</p>
          </div>
        </div>
        ...
        <div class="row">
          <div class="input-field col s12 m12 l6">
              <p class="margin right-align medium-small"><a href="<?= site_url() ?>login">Login</a></p>
          </div>          
        </div>
