...
<head>
  ...
  <title>Login <?= mainweb('nama') ?></title>

  <!-- Favicons-->
  <link href="https://park.functionwebdevelop.com/assets/front/img/gallery/newlogo.png" rel="icon">
  <!-- Favicons-->
...
<body class="purple purple.darken-2">
  <!-- Start Page Loading -->
    ...
    <div class="col s12 z-depth-4 card-panel">
        ...
        <div class="row">
          <div class="input-field col s12 center">
            <img src="<?= base_url() ?>logo/<?= mainweb('logo') ?>" alt="" class="circle responsive-img valign profile-image-login">
            <p class="center login-form-text">Login <?= mainweb('nama') ?></p>
          </div>
        </div>
        ...
        <div class="row">
          <div class="input-field col s12">
              <button type="submit" class="btn waves-effect purple purple.darken-2 col s12">Login</button>
          </div>
        </div>
        <div class="row">
