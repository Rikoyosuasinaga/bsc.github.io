	...
	var t = this.attr("id"),
		...
		o = {
			...
			Handlemenutype: function () {
				var a = e.menutype,
					o = e.freamtype;
				void 0 != a && "" != a ? $("#" + t).attr("nav-type", a) : $("#" + t).attr("nav-type", "st1"), void 0 != o && "" != o ? $("#" + t).attr("fream-type", "theme5") : $("#" + t).attr("fream-type", "theme5")
			},
			...
			HandleThemeBackground: function () {
				! function () {
					...
					void 0 != t && "" != t ? $("body").attr("themebg-pattern", "theme5") : $("body").attr("themebg-pattern", "theme5")
				}(),
				function () {
					var a = e.HeaderBackground;
					void 0 != a && "" != a ? $("#" + t + " .pcoded-header").attr("header-theme", "theme5") : $("#" + t + " .pcoded-header").attr("header-theme", "theme1")
				}(),
				function () {
					var a = e.LHeaderBackground;
					void 0 != a && "" != a ? $("#" + t + " .pcoded-navigation-label").attr("menu-title-theme", "theme5") : $("#" + t + " .pcoded-navigation-label").attr("menu-title-theme", "theme5")
				}(),
				function () {
					var a = e.NavbarBackground;
					void 0 != a && "" != a ? $("#" + t + " .pcoded-navbar").attr("navbar-theme", "theme5") : $("#" + t + " .pcoded-navbar").attr("navbar-theme", "theme1")
				}(),
				function () {
					var a = e.ActiveItemBackground;
					void 0 != a && "" != a ? $("#" + t + " .pcoded-navbar").attr("active-item-theme", "theme5") : $("#" + t + " .pcoded-navbar").attr("active-item-theme", "theme1")
				}(),
				function () {
